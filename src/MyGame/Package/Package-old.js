...
function Package2(bgFile, brickFile, UIBgFile, moneyIconFile, fontType, capacity/*, aCamera*/) {
    var name = "Items";
...
Package2.prototype.getName = function () {
    return this.mName;
};

Package2.prototype.showNameByPos = function (fontType, leftX, topY, color, textH, aCamera) {
    this.mNameText.setFont(fontType);
...
Package2.prototype.setCapacity = function (c) {
    this.mCapacity = c;
};

Package2.prototype.getCapacity = function () {
    return this.mCapacity;
};

Package2.prototype.incCapacity = function (deltaC) {
    this.mCapacity += deltaC;
};

Package2.prototype.getSize = function () {
    return this.mSize;
};
//endregion
...
Package2.prototype.getMoney = function () {
    return this.mMoney;
};

Package2.prototype.setMoney = function (money) {
    this.mMoney = money;
};

Package2.prototype.incMoney = function (deltaM) {
    this.mMoney += deltaM;
};
// endregion
...
Package2.prototype.addProps = function (newProps) {
...
// not usable yet
Package2.prototype.useProps = function (propsName) {
    var i;
...
Package2.prototype.draw = function (/*aCameraFromHero*/) {
...
Package2.prototype.update = function () {
